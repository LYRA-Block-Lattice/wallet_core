...
//       '0x782c578B5BC3b9A1B6E1E54f839B610Ac7036bA0'; // DAIPoints
//   num tokenAmount = 0.1;
...
//   String data = await web3.getEncodedDataForContractCall('DAIPointsToken',
//       contractAddress, 'getDAIPointsToAddress', [amount, receiver]);
//   print('data: $data');

//   dynamic result = await api.approveTokenAndCallContract(
//       web3, walletAddress, tokenAddress, contractAddress, tokenAmount, data,
//       network: 'mainnet');
//   print('result: $result');
// }
